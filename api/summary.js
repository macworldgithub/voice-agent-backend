...
export const config = {
  api: {
    bodyParser: false, // required for multer + multipart
  },
};
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const attachments = [
      { filename: 'summary.txt',    content: summary || 'No summary provided.' },
      { filename: 'transcript.txt', content: transcript || 'No transcript provided.' }
    ];
